...
MTLRenderPipelineDescriptor* MetalShader::setupMaterial(const Material& material, id<MTLTexture> renderTarget) {
	if (descriptor) {
		return descriptor;
	}
	...
	descriptor.colorAttachments[0].pixelFormat = renderTarget.pixelFormat;
